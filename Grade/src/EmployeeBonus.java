class Employee{
			...
			System.out.println("Bonus of Employee " + e.getName() + " is: " + bonus);
		   ...
		   Employee e1= new Employee(1,"nisarga",15000,"Manager");
			Employee e2 = new Employee(1,"punya", 25000, "Lead");
			Employee e3 = new Employee(1,"diya", 35000, "Associate");
		    calculateBonus(e1);
			calculateBonus(e2);
			calculateBonus(e3);
